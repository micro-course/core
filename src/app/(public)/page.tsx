...
export default async function Home() {
  return (
    <main className="flex min-h-screen flex-col py-14 p-8 container max-w-[900px]">
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        <b>Вся индустия IT образования сосредоточена на новичках.</b> Как
        развиваться опытным разработчикам, вообще не понятно.
      </p>
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        У нас мало времени, что бы проходить огромные курсы. У нас слишком
        разные знания, что бы универсальная программа была полезной. Я готов
        заплатить деньги за узкие знания.{" "}
        <i>
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        Но и авторам делать курсы для опытных не выгодно. Маленькая аудитерия,
        сложность разработки и низкие чеки. Что бы продавать нужно обязательно
        быть блогером.
      </p>
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        <b>
          Так и получается. Либо ты делаешь контент для новичков или идёшь
          лесом.
        </b>
      </p>
      <p className="leading-7 [&:not(:first-child)]:mt-6">
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2 ">
        ...
        <li>ученикам - осваивать самымые глубокие темы программирования</li>
      </ul>
      <p className="leading-7 [&:not(:first-child)]:mt-6">
